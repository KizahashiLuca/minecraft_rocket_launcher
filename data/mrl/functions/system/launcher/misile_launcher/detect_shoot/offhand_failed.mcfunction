...
## Add a tag
tag @p[tag=MRL_ShotLauncher,predicate=mrl:after_shot/misile_launcher/offhand] add MRL_ShotMisileLauncher

## Replace item
loot replace entity @p[tag=MRL_ShotMisileLauncher] weapon.offhand loot mrl:misile_launcher
