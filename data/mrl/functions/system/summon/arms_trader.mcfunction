...
## Summon Arms Trader
execute at @e[type=minecraft:area_effect_cloud,tag=MRL_SummonTraderArea,limit=1] run summon minecraft:wandering_trader ~ ~ ~ {CustomName:'{"text":"Arms Trader","italic":false}',CustomNameVisible:0b,Offers:{Recipes:[{maxUses:12,buy:{id:"minecraft:emerald",Count:3b},buyB:{id:"minecraft:crossbow",Count:1b},sell:{id:"minecraft:crossbow",Count:1b,tag:{display:{Name:'["",{"text":"Rocket Launcher","color":"aqua","italic":false}]'},ChargedProjectiles:[{id:"minecraft:firework_rocket",Count:1b,tag:{display:{Name:'["",{"text":"Unguided projectile (Rocket)","color":"aqua","italic":false}]'}}}],Damage:0,Charged:1b,Tags:["MRL_RocketLauncher"]}},xp:2,uses:0,priceMultiplier:0.05f,specialPrice:0,demand:0,rewardExp:1b},{maxUses:10,buy:{id:"minecraft:emerald",Count:5b},buyB:{id:"minecraft:crossbow",Count:1b},sell:{id:"minecraft:crossbow",Count:1b,tag:{display:{Name:'["",{"text":"Misile Launcher","color":"aqua","italic":false}]'},ChargedProjectiles:[{id:"minecraft:firework_rocket",Count:1b,tag:{display:{Name:'["",{"text":"Guided projectile (Misile)","color":"aqua","italic":false}]'}}}],Damage:0,Charged:1b,Tags:["MRL_MisileLauncher"]}},xp:2,uses:0,priceMultiplier:0.05f,specialPrice:0,demand:0,rewardExp:1b}]},DespawnDelay:10000,Tags:["MRL_NotSetTarget","MRL_ArmsTrader"]}
...
## Summon mule
execute at @e[type=minecraft:area_effect_cloud,tag=MRL_SummonTraderArea,limit=1] run summon minecraft:mule ~ ~ ~ {Leashed:1b,ChestedHorse:1b,Tags:["MRL_NotSetTarget"]}
