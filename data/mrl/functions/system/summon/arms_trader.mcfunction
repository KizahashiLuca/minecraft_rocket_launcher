...
## Set target
execute store result entity @e[type=minecraft:wandering_trader,tag=MRL_NotSetTarget,limit=1] WanderTarget.X int 1.0 run data get entity @p[sort=nearest] Pos[0]
execute store result entity @e[type=minecraft:wandering_trader,tag=MRL_NotSetTarget,limit=1] WanderTarget.Y int 1.0 run data get entity @p[sort=nearest] Pos[1]
execute store result entity @e[type=minecraft:wandering_trader,tag=MRL_NotSetTarget,limit=1] WanderTarget.Z int 1.0 run data get entity @p[sort=nearest] Pos[2]
